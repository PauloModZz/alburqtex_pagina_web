...
export default function LegalPageRoute() {
  ...
  useSeo({
    title: 'Términos, privacidad y cookies',
    description: 'Términos y condiciones, política de privacidad, cookies y envíos/devoluciones de Alburqtex.',
    path: '/legal',
  });

  return <LegalPage onBack={() => navigate('/')} scrollToId={params.get('section') ?? undefined} />;
}
